...
export const adminApi = {
  ...
  createCourse: (token, body) => request("/admin/courses", { method: "POST", token, body }),
  updateCourse: (token, courseId, body) => request(`/admin/courses/${courseId}`, { method: "PUT", token, body }),
  ...
  updateModule: (token, moduleId, body) => request(`/admin/modules/${moduleId}`, { method: "PUT", token, body }),
  ...
  updateLesson: (token, lessonId, body) => request(`/admin/lessons/${lessonId}`, { method: "PUT", token, body }),
  ...
  updateExercise: (token, exerciseId, body) => request(`/admin/exercises/${exerciseId}`, { method: "PUT", token, body }),
  deleteExercise: (token, exerciseId) => request(`/admin/exercises/${exerciseId}`, { method: "DELETE", token }),
